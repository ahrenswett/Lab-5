...
{ //eslint-disable-line
    var sumOfSum = a+b;
    var stringofSum = ('The sum of ' +a+ ' and ' +b+ ' is 11.');
    return[sumOfSum, stringofSum];
}
...
//between GitHub and your laptop. Don't forget to create a new branch for your work 
//on the next question!

/////////////////////////////////////
/* Problem 3
Write a function called sumAndMultiply() that takes in three numbers as 
separate arguments and returns an array where the first element is the sum 
of those three numbers, the second element is the product of those three numbers,  and the third and fourth 
...
{ //eslint-disable-line
    var sumOf2 = sum(a,b)[0];
    var sumOfAll = sum(sumOf2, c)[0];
    var productOf2 = multiply(a, b)[0];
    var productOfAll = multiply(productOf2, c)[0];
    var sumString = (a+' and '+b+' and '+c+ ' sum to '+sumOfAll+'.');
    var productString = ('The product of '+a+' and '+b+' and '+c+' is '+productOfAll+'.');
    return[sumOfAll, productOfAll, sumString, productString];
}
...
{ //eslint-disable-line
    var sumOf2 = sum(testArray[0],testArray[1])[0];
    var sumOfAll = sum(testArray[2],sumOf2)[0];
    var stringOfArray= (testArray+' was passed in as an array of numbers, and '+ sumOfAll +' is their sum.');
    return[sumOfAll, stringOfArray]
}
...
is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that 
...
function multiplyArray(multArr) { //eslint-disable-line
    var productOf2 = multiply(multArr[0],multArr[1])[0];
    var productOfArray = multiply(productOf2,multArr[2])[0];
    var arrayString = ('The numbers ' +multArr+ ' have a product of ' +productOfArray+ '.');
    return[productOfArray, arrayString];
}
...
{ //eslint-disable-line
    ...
    for(var i=1; i < dynamicArray.length ; i++)
    {
        ...
        {
            productOfArray = multiply(dynamicArray[i],productOfArray)[0];
        }
        console.log(`${i} is the loop count`);
    }
    var arrayString =(`The numbers ${dynamicArray} have a product of ${productOfArray}.`)
    console.log(`${productOfArray} is the product of array`);
    return[productOfArray, arrayString]
}
